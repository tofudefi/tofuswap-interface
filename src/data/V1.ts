...
export class MockV1Pair extends Pair {
  constructor(etherAmount: BigintIsh, tokenAmount: TokenAmount) {
    super(tokenAmount, new TokenAmount(WTRX[tokenAmount.token.chainId], etherAmount))
  }
}
...
export function useV1Trade(
  ...
  const inputIsETH = inputCurrency === TRX
  const outputIsETH = outputCurrency === TRX
